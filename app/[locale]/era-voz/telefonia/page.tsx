...
import TelefoniaPageClient from "@/components/era-voz/pages/TelefoniaPageClient"
import { getVozPageBySlug } from "@/data/era-voz-pages"

const page = getVozPageBySlug("telefonia")!

export const metadata: Metadata = {
  title: page.metaTitle,
  description: page.metaDescription,
  openGraph: { title: page.metaTitle, description: page.metaDescription, type: "website", url: `/era-voz/telefonia` },
}
...
function JsonLd() {
  ...
  const breadcrumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "/" }, { "@type": "ListItem", position: 2, name: "Voz", item: "/era-voz" }, { "@type": "ListItem", position: 3, name: page.title, item: `/era-voz/telefonia` }] }
...
export default function Page() {
  return (<main className="min-h-screen" style={{ backgroundColor: "#2b363d" }}><JsonLd /><TelefoniaPageClient /></main>)
}
