...
import CampanhasPageClient from "@/components/era-voz/pages/CampanhasPageClient"
import { getVozPageBySlug } from "@/data/era-voz-pages"

const page = getVozPageBySlug("campanhas")!

export const metadata: Metadata = {
  title: page.metaTitle,
  description: page.metaDescription,
  openGraph: { title: page.metaTitle, description: page.metaDescription, type: "website", url: `/era-voz/campanhas` },
}
...
function JsonLd() {
  ...
  const breadcrumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "/" }, { "@type": "ListItem", position: 2, name: "Voz", item: "/era-voz" }, { "@type": "ListItem", position: 3, name: page.title, item: `/era-voz/campanhas` }] }
...
export default function Page() {
  return (<main className="min-h-screen" style={{ backgroundColor: "#2b363d" }}><JsonLd /><CampanhasPageClient /></main>)
}
