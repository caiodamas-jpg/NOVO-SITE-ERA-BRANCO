...
const page = getPageBySlug("ia-generativa")!

export const metadata: Metadata = {
  title: page.metaTitle,
  description: page.metaDescription,
  openGraph: { title: page.metaTitle, description: page.metaDescription, type: "website", url: `/era-chat/ia-generativa` },
}
...
function JsonLd() {
  ...
  const breadcrumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "/" }, { "@type": "ListItem", position: 2, name: "Chat", item: "/era-chat" }, { "@type": "ListItem", position: 3, name: page.title, item: `/era-chat/ia-generativa` }] }
  return (
    <>
