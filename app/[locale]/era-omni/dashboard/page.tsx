...
import DashboardPageClient from "@/components/era-omni/pages/DashboardPageClient"
import { getOmniPageBySlug } from "@/data/era-omni-pages"

const page = getOmniPageBySlug("dashboard")!

export const metadata: Metadata = {
  title: page.metaTitle,
  description: page.metaDescription,
  openGraph: { title: page.metaTitle, description: page.metaDescription, type: "website", url: "/era-omni/dashboard" },
}
...
function JsonLd() {
  ...
  const breadcrumb = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "/" }, { "@type": "ListItem", position: 2, name: "Mensageria", item: "/era-omni" }, { "@type": "ListItem", position: 3, name: page.title, item: "/era-omni/dashboard" }] }
...
export default function Page() {
  return (<main className="min-h-screen" style={{ backgroundColor: "#2b363d" }}><JsonLd /><DashboardPageClient /></main>)
}
