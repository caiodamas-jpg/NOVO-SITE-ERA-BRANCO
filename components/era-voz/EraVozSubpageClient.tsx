  ...
  return (
    <>
      ...
      <section className="pt-32 pb-16 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <h1 className="text-3xl md:text-4xl lg:text-[48px] font-medium text-gray-900 mb-5" style={{ letterSpacing: "-0.0325em", lineHeight: 1.1, fontVariationSettings: '"opsz" 28' }}>{page.h1}</h1>
      ...
      <section className="py-16 px-6 border-t border-gray-200 bg-white">
        <div className="max-w-3xl mx-auto space-y-4 text-gray-500 text-sm leading-relaxed">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-900 mb-6" style={{ letterSpacing: "-0.0325em" }}>Por que escolher o {page.title} da ERA</h2>
          <p>O <span className="text-gray-900 font-medium">{page.title}</span> da ERA centraliza toda a operação de voz em uma plataforma cloud, sem hardware e com escalabilidade imediata.</p>
          <p>Combinado com <Link href="/era-voz/monitoramento" className="text-gray-900 font-medium underline underline-offset-2 hover:opacity-80">monitoramento em tempo real</Link>, <Link href="/era-voz/cti" className="text-gray-900 font-medium underline underline-offset-2 hover:opacity-80">CTI com +100 integrações</Link> e <Link href="/era-voz/relatorios" className="text-gray-900 font-medium underline underline-offset-2 hover:opacity-80">relatórios avançados</Link>, você tem controle total da operação.</p>
        </div>
      </section>
