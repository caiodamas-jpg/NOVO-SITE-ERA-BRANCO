...
const pageData = getVozPageBySlug("monitoramento")!
const related = getVozRelatedPages(pageData.relatedSlugs)

export default function MonitoramentoPageClient() {
  ...
  return (
    <>
      ...
      <BlogAndSlideshow tags={["monitoramento", "voz", "telefonia"]} categoryProduct="era-voz" />
