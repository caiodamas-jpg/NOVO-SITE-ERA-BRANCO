...
const pageData = getVozPageBySlug("telefonia")!
const related = getVozRelatedPages(pageData.relatedSlugs)

export default function TelefoniaPageClient() {
  ...
  return (
    <>
      ...
      <BlogAndSlideshow tags={["telefonia", "voz", "telefonia"]} categoryProduct="era-voz" />
