  ...
  return (
    <>
        ...
        <div className="max-w-5xl mx-auto">
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center gap-1.5 text-xs text-gray-500">
              ...
              <li><ChevronRight className="w-3 h-3" /></li>
              <li className="text-gray-600">URA Inteligente</li>
            </ol>
          </nav>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <h1 className="text-3xl md:text-4xl lg:text-[48px] font-medium text-gray-900 mb-5" style={{ letterSpacing: "-0.0325em", lineHeight: 1.1, fontVariationSettings: '"opsz" 28' }}>
              URA Inteligente — Atendimento automatizado que direciona com precisão
            </h1>
            <p className="text-gray-500 text-base max-w-2xl mb-8">
              URA multinível com saudação longa e curta, discagem direta (cut-through), timeout configurável, regras de tempo por departamento e aviso técnico para situações de crise.
            </p>
            <div className="flex flex-wrap gap-3">
              ...
              <Link href="/pricing#era-voz" className="px-4 py-2 md:px-5 md:py-2.5 border border-gray-300 text-gray-900 font-medium rounded-lg hover:bg-gray-100 transition-colors text-xs md:text-sm">
                Ver planos Voz
              </Link>
            </div>
          </motion.div>
      ...
      <section className="py-16 px-6 border-t border-gray-200 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-900 mb-3 text-center" style={{ letterSpacing: "-0.0325em" }}>
            Veja como a URA direciona uma ligação
          </h2>
          <p className="text-gray-500 text-sm text-center mb-10 max-w-lg mx-auto">
            O cliente liga, a URA apresenta as opções, o cliente escolhe e é direcionado para o setor correto automaticamente.
          </p>
          <UraFlowAnimation />
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="rounded-xl border border-orange-500/20 bg-orange-500/5 p-6">
            ...
            <p className="text-gray-500 text-xs">
              Barreira eficaz para gerenciar grandes volumes em situações específicas — reduz drasticamente o tempo de espera nas filas.
            </p>
          </div>
        </div>
      </section>
