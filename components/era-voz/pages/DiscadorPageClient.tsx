...
const pageData = getVozPageBySlug("discador")!
const related = getVozRelatedPages(pageData.relatedSlugs)

export default function DiscadorPageClient() {
  ...
  return (
    <>
      ...
      <BlogAndSlideshow tags={["discador", "voz", "telefonia"]} categoryProduct="era-voz" />
