...
const pageData = getVozPageBySlug("relatorios")!
...
export default function RelatoriosPageClient() {
  ...
  return (
    <>
        ...
        <div className="max-w-5xl mx-auto">
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center gap-1.5 text-xs text-gray-500">
              ...
              <li><ChevronRight className="w-3 h-3" /></li>
              <li className="text-gray-600">Gravação e Relatórios</li>
            </ol>
          </nav>
      ...
      {/* Reuse the audio transcription + video section from home */}
      <ProductDirectionSection />

      {/* Features */}
      <section className="py-16 px-6 border-t border-gray-200 bg-white">
        <div className="max-w-5xl mx-auto space-y-6">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-900 mb-10" style={{ letterSpacing: "-0.0325em" }}>Relatórios disponíveis</h2>
