...
import TeamManagementAnimation from "../TeamManagementAnimation"
import { getOmniPageBySlug, getOmniRelatedPages } from "@/data/era-omni-pages"

const pageData = getOmniPageBySlug("gestao-equipes")!
const related = getOmniRelatedPages(pageData.relatedSlugs)

export default function GestaoEquipesPageClient() {
