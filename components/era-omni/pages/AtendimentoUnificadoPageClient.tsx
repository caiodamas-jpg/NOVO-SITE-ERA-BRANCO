...
const pageData = getOmniPageBySlug("atendimento-unificado")!
const related = getOmniRelatedPages(pageData.relatedSlugs)

export default function AtendimentoUnificadoPageClient() {
  ...
  return (
    <>
      ...
      <BlogAndSlideshow tags={["atendimento-unificado", "omnichannel", "atendimento"]} categoryProduct="era-omni" />
