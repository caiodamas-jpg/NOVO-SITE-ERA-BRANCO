...
import InsuranceFlowAnimation from "../InsuranceFlowAnimation"
import { getOmniPageBySlug, getOmniRelatedPages } from "@/data/era-omni-pages"

const pageData = getOmniPageBySlug("enterprise")!
...
export default function EnterprisePageClient() {
  ...
  return (
    <>
      ...
      <BlogAndSlideshow tags={["enterprise", "omnichannel", "atendimento"]} categoryProduct="era-omni" />
