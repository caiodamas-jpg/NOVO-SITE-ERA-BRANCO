...
import DashboardChartsAnimation from "../DashboardChartsAnimation"
import { getOmniPageBySlug, getOmniRelatedPages } from "@/data/era-omni-pages"

const pageData = getOmniPageBySlug("dashboard")!
...
export default function DashboardPageClient() {
  ...
  return (
    <>
      ...
      <BlogAndSlideshow tags={["dashboard", "omnichannel", "atendimento"]} categoryProduct="era-omni" />
